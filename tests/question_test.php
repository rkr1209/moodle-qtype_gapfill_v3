...
require_once($CFG->dirroot . '/question/type/gapfill_v3/question.php');
/**
 * Unit tests for the gapfill question definition class.
 *
...
class question_test extends advanced_testcase {
    public function test_get_expected_data() {
        $question = qtype_gapfill_v3_test_helper::make_question();
    ...
    public function test_get_delimit_array() {
        $delimchars = qtype_gapfill_v3::get_delimit_array('[]');
    ...
    public function test_discard_duplicates() {
        ...
        $question = qtype_gapfill_v3_test_helper::make_question($questiontext, $options);
    ...
    public function test_get_validation_error() {
        ...
        $question = qtype_gapfill_v3_test_helper::make_question($questiontext);
        $question->gapcount = 2;
